...
public class AddToIdentifierConfirmation implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        //String sqlQuery2 = "INSERT INTO public.buffer (program_id,token,identifier_type,identifier) VALUES (:program_id,:token,:identifier_type,:identifier) RETURNING buffer_id";
