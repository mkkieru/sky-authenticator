...
public class GetAuthDetails implements HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        //String sqlQuery = "SELECT * ,age(now(),date_updated) FROM public.auth_details where user_id = (:user_id) and identifier = (:identifier)";
        String sqlQuery = "SELECT age(now(),date_updated), * FROM public.auth_details where user_id = (:user_id) and identifier = (:identifier)";
        ...
        if (responseCodes == ResponseCodes.ERROR) {
            ...
            try {
                ...
                value = usersDao.getUserSpecificAuthDetails(sqlQuery, values);
