...
public class DeactivateUserCodes implements HttpHandler {

    @Override
    public void handleRequest(HttpServerExchange httpServerExchange) throws Exception {

        String sqlQuery = "update public.auth_details set status = 'INACTIVE' where user_id = :user_id and status = 'ACTIVE' " ;
